...
#define PPU_HORIZONTAL_RESOLUTION           341       // Горизонтальное разрешение экрана ( для системы PAL )
#define PPU_VERTICAL_PAL_RESOLUTION         262       // Вертикальное разрешение экрана ( для системы PAL )
...
private:
    inline void BgRenderingRun( void );
    inline void BgFetchRun( void );

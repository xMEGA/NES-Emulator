...
${OBJECTDIR}/_ext/837277161/File.o: ../../../src/FileManager/File.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../../src/Source -I../../src/Source/GameConsole -I../../../thirdparty/SDL2/build/linux_x86_64/include/SDL2 -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/837277161/File.o ../../../src/FileManager/File.cpp
